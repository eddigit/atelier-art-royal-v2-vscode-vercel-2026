...
export const metadata = {
  title: 'Conditions Générales de Vente | Atelier Art Royal',
  description: 'Conditions générales de vente du site Atelier Art Royal',
};
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto bg-white rounded-lg p-8 shadow-sm">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4">Article 4 - Commande</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4">Article 6 - Livraison</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4">Article 8 - Garantie</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4">Article 9 - Réclamations</h2>
              <p className="text-gray-600">
